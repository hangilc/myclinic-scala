...
object KoukikoureiValidator:
  ...
  object NonPositiveKoukikoureiId extends KoukikoureiError("Zero koukikourei-id")
  ...
  object NonPositiveHihokenshaBangou extends KoukikoureiError("被保険者番号が正の整数でありません。")
  object InvalidFutanWari extends KoukikoureiError("Invalid futan-wari value (should be 1, 2, or 3")
