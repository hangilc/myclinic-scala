...
trait AppEventCodec extends Model:
  given Encoder[AppModelEvent] with 
    def apply(e: AppModelEvent): Json = 
      e match {
        case AppointCreated(at, created) => Json.obj(
          "model" -> Json.fromString("appoint"),
          "kind" -> Json.fromString("created"),
          "createdAt" -> at.asJson,
          "created" -> created.asJson
        )
        case AppointUpdated(at, updated) => Json.obj(
          "model" -> Json.fromString("appoint"),
          "kind" -> Json.fromString("updated"),
          "createdAt" -> at.asJson,
          "updated" -> updated.asJson
        )
        case AppointDeleted(at, deleted) => Json.obj(
          "model" -> Json.fromString("appoint"),
          "kind" -> Json.fromString("deleted"),
          "createdAt" -> at.asJson,
          "deleted" -> deleted.asJson
        )
        case AppointTimeCreated(at, created) => Json.obj(
          "model" -> Json.fromString("appoint-time"),
          "kind" -> Json.fromString("created"),
          "createdAt" -> at.asJson,
          "created" -> created.asJson
        )
        case AppointTimeUpdated(at, updated) => Json.obj(
          "model" -> Json.fromString("appoint-time"),
          "kind" -> Json.fromString("updated"),
          "createdAt" -> at.asJson,
          "updated" -> updated.asJson
        )
        case AppointTimeDeleted(at, deleted) => Json.obj(
          "model" -> Json.fromString("appoint-time"),
          "kind" -> Json.fromString("deleted"),
          "createdAt" -> at.asJson,
          "deleted" -> deleted.asJson
        )
        case UnknownAppEvent(appEventId, createdAt, model, kind, data) => Json.obj(
