...
object Icons:
  ...
  // </svg>
  def calendar(size: String = "1.5rem", color: String = "black"): HTMLElement =
    makeIcon(
      size,
      color,
      List(
  ...
  // </svg>
  def dotsHorizontal(size: String = "1.5rem", color: String = "black"): HTMLElement =
    makeIcon(
      size,
      color,
      List(
  ...
  // </svg>    
  def dotsVertical(size: String = "1.5rem", color: String = "black"): HTMLElement =
    makeIcon(
      size,
      color,
      List(
  ...
  // </svg>
  def menu(size: String = "1.5rem", color: String = "black"): HTMLElement =
    makeIcon(
      size,
      color,
      List(
  ...
  // </svg>
  def menuAlt4(size: String = "1.5rem", color: String = "black"): HTMLElement =
    makeIcon(
      size,
      color,
      List(
  ...
  // </svg>  
  def zoomIn(size: String = "1.5rem", color: String = "black"): HTMLElement =
    makeIcon(
      size,
      color,
      List(
  ...
  // </svg>
  def zoomOut(size: String = "1.5rem", color: String = "black"): HTMLElement =
    makeIcon(
      size,
      color,
      List(
