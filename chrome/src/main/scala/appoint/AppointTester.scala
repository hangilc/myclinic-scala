...
class AppointTester:
  ...
  def testEnter(): Unit =
    ...
    box.e.click()
    val dlog = new MakeAppointDialogElement(driver.findElement(ByClassName("domq-modal")))
    dlog.insertName("1\n")
  ...
  def findVacantAppointBox: AppointTimeBoxElement =
    ...
    new AppointTimeBoxElement(c.e.findElement(ByCssSelector(".appoint-time-box.vacant")))
